...
let test_startsWith = function () {
    ensure(startsWith('guagua', 'gua') === true, '测试1')
    ensure(startsWith('guagua', 'melon') === false, '测试2')
    ensure(startsWith('melongua', 'gua') === false, '测试2')
}
test_startsWith()
// 用法如下, 作为测试参考
...
let test_findIn = function () {
    ensure(findIn('asdasdasd', 'a') === 0, '测试1')
    ensure(findIn('asdasdasd', 's') === 1, '测试2')
    ensure(findIn('asdasdasd', 'f') === -1, '测试3')
}
test_findIn()
